...
variable "zeppelin_name" {
  description = "Zeppelin Database User Name."
  default     = "zeppelin"
}

variable "zeppelin_password" {
  description = "Zeppelin Database User Password."
  default     = "MyZEPpassw0rd!"
}
...
variable "zeppelin_instance_name" {
  description = "Name of the Zeppelin compute instance"
  default     = "ZeppelinServer"
}
